...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ValueListenableBuilder<Box<  ModelofNotes>>(
        valueListenable: Boxes.getData().listenable(),
        builder: (context,box ,_){
          var data = box.values.toList().cast< ModelofNotes>();
          return Padding(
    ...
    void delete( ModelofNotes )async{
      await ModelofNotes.delete() ;
    }


  Future<void> _editDialog( ModelofNotes notesModel, String title, String description)async{
          ...
          builder:(context){
            return AlertDialog(
              ...
              actions: [
                ...
                TextButton(onPressed: (){
                  final data =  ModelofNotes(title: titleController.text,
